...
public void Init() { 
    ...
    /// </ summary > > /// < param name =" cSSO" > CardSpriteSO to be assigned to the Singleton S </ param > 
...
/// < summary > > /// Searches S.faceSprites for the one with the right name 
/// </ summary > > /// < param name =" name" > The name to search for </ param > 
/// < returns > A face Sprite </ returns > >
 ...
 public static Sprite GET_FACE(string name) { 
    foreach (Sprite spr in S.faceSprites) { 
        ...
        /// < summary > > /// This public static property makes S.cardBack accessible to other classes > /// </ summary > > 
        public static Sprite BACK { 
             get {return S.cardBack;} 
             } 
            /// < summary > > /// Call this to reset the Singleton S to null at the end of a game > /// </ summary > > 
