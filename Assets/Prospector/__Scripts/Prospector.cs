...
// We’ll need this line later in the chapter 
...
/// < summary > > /// Converts each Card in a List( Card) into a List( CardProspector) so that it > /// can be used in the Prospector game. > /// </ summary > 
/// < param name =" listCard" > A List( Card) to be converted </ param > > /// < returns > A List( CardProspector) of the converted cards </ returns > //
...
CardProspector Draw() { 
    ...
    return(cp); // And return

} 


/// < summary > > /// Positions the initial tableau of cards, a.k.a. the "mine" 
/// </ summary > 
...
void MoveToDiscard(CardProspector cp) { 
    ...
    cp.SetLocalPos(new Vector3( 
        ...
        /// < summary > > /// Make cp the new target card > /// </ summary >
    ...
    void MoveToTarget(CardProspector cp) { 
        ...
        /// < summary > > /// Arranges all the cards of the drawPile to show how many are left > /// </ summary > 
         void UpdateDrawPile() { 
            CardProspector cp; 
...
/// This turns cards in the Mine face-up and face-down > /// </ summary > 
