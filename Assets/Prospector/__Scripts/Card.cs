...
// < summary > > /// Creates this Card’s visuals based on suit and rank. 
/// Note that this method assumes it will be passed a valid suit and rank. > /// </ summary > > /// < param name =" eSuit" > The suit of the card (e.g., ’C’) </ param > > /// < param name =" eRank" > The rank from 1 to 13 </ param > > /// < returns > </ returns > 
...
/// < summary > > /// Adds the decorators to the top-left and bottom-right of each card. > /// Decorators are the suit and rank in the corners of each card. > /// </ summary > 
...
/// < summary > > /// Adds pips to the front of all cards from A to 10 > /// </ summary > 
...
/// < summary > > /// Adds the face sprite for card ranks 11 to 13 > /// </ summary > 
...
/// < summary > > /// Gather all SpriteRenderers on this and its children
...
void PopulateSpriteRenderers() { 
    ...
    /// < summary > > /// Moves the Sprites of this Card into a specified sorting layer > /// </ summary > 
    ...
    public void SetSpriteSortingLayer(string layerName) { 
        ...
        foreach (SpriteRenderer srend in spriteRenderers) { 
            ...
            /// < summary > > /// Sets the sortingOrder of the Sprites on this Card. This allows multiple > /// Cards to be in the same sorting layer and still overlap properly, and > /// it is used by both the draw and discard piles. > /// </ summary > 
