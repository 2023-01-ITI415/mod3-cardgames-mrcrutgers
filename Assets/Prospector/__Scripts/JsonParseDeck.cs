...
if (S != null) { 
    ...
    /// < summary > > /// Returns the decorator layout information for all cards. > /// </ summary > > 
    static public List <JsonPip> DECORATORS { 
        get { return S.deck.decorators; } 
        }  


        /// < summary > > /// Returns the JsonCard matching the rank passed in. > 
        /// Note: The rank should be 1 (Ace) - 13 (King). > 
        /// </ summary > > /// < param name =" rank" Must be an int in range 1-13 </ param > > 
